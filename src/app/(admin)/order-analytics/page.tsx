    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="flex items-center space-x-3">
          ...
          <span className="text-lg text-gray-600 dark:text-gray-400">Loading order analytics...</span>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">Detailed view and analysis of all orders across platforms</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                <div className="text-2xl font-bold text-gray-900 dark:text-white">{orderStats.totalOrders}</div>
                <div className="text-sm text-gray-600 dark:text-gray-400">Total Orders</div>
              </div>
            </div>
            <p className="text-xs text-gray-500 dark:text-gray-400">In current filter</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="text-2xl">💰</div>
              <div className="text-right">
                <div className="text-2xl font-bold text-gray-900 dark:text-white">฿{orderStats.totalAmount.toLocaleString()}</div>
                <div className="text-sm text-gray-600 dark:text-gray-400">Total Value</div>
              </div>
            </div>
            <p className="text-xs text-gray-500 dark:text-gray-400">Sum of order amounts</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="text-2xl">📈</div>
              <div className="text-right">
                <div className="text-2xl font-bold text-gray-900 dark:text-white">฿{orderStats.averageAmount.toLocaleString()}</div>
                <div className="text-sm text-gray-600 dark:text-gray-400">Average Order</div>
              </div>
            </div>
            <p className="text-xs text-gray-500 dark:text-gray-400">Mean order value</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="text-2xl">📱</div>
              <div className="text-right">
                <div className="text-2xl font-bold text-yellow-600 dark:text-yellow-400">{orderStats.statusCounts.pending_scan}</div>
                <div className="text-sm text-gray-600 dark:text-gray-400">Pending Scans</div>
              </div>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Shop Filter */}
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Shop</label>
              <select
                value={selectedShop}
        ...
        {filteredOrders.length > 0 && (
          <div 
            id="export-options"
            className={`mt-8 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 transition-all duration-1000 ${
              highlightExport ? 'ring-4 ring-blue-500 ring-opacity-50 bg-blue-50 dark:bg-blue-900/30 rounded-lg highlight-export' : ''
            }`}
          >
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Export Options</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Export data for RPA automation into your ERP system.</p>
            <div className="flex space-x-4">
              ...
              <button className="px-4 py-2 bg-purple-600 dark:bg-purple-700 text-white rounded-lg hover:bg-purple-700 dark:hover:bg-purple-800 transition-colors">
                Generate Report
              </button>
            </div>
          </div>
